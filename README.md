...
## News
-  :pushpin: This repo not only supports PointNeXt, but also other projects of [Guocheng Qian](https://www.gcqian.com), including [ASSANet](https://arxiv.org/abs/2110.10538) (NeurIPS 2021 Spotlight, efficient point cloud processing) and [Pix4Point](https://arxiv.org/abs/2208.12259)
...
see [Install](docs/index.md) for detail. 
